<template>
    <div>
        ...
        <ul>
            ...
            <li><a href="https://vuejs.org/">Vue.js</a> and ES6 using <a href="https://babeljs.io/">BableJs</a> for client-side code</li>
            <li><a href="https://webpack.github.io/">Webpack</a> for building and bundling client-side resources</li>
            <li><a href="https://github.com/aspnet/SignalR">SignalR Alpha</a> for realtime socket based communication between clients and server.</a></li>
